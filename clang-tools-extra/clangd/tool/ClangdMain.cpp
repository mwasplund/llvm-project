...
opt<Path> BuildServerExe{
    "bsp",
    cat(Features),
    desc("Specify an executable to function as the BSP for communication "
         "with a build system to query for information about the "
         "compilation commands or to perform continuous builds"),
};
...
private:
  static llvm::StringRef testDir() {
    ...
    static const std::string TestDir =
        llvm::sys::path::native("C:/clangd-test");
    return TestDir;
#else
    return "/clangd-test";
#endif
...
clangd accepts flags on the commandline, and in the CLANGD_FLAGS environment variable.
  ...
  Opts.BuildServer = BuildServerExe;
